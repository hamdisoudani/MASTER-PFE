...
The [`skill/`](./skill/) folder contains **documented patterns and lessons learned** by the AI agent during real sessions — covering Composio integrations, GitHub workflows, E2B sandboxes, and more.

> If you are an agent starting a new session: **read [`skill/composio.md`](./skill/composio.md) before touching any GitHub or E2B tooling.**
...
├── skill/              # ← Agent skill docs (Composio, GitHub, E2B patterns)
├── docker-compose.yml
